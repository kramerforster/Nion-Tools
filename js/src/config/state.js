export const info = {
    ...
    spButtons: [
        { id: 1, row: 1, text: "Обновление", action: () => window.sendClientEvent(0, "OnSelectSpectateMenu", 0), disabled: false },
        { id: 2, row: 1, text: "Статистика", action: () => window.sendClientEvent(0, "OnSelectSpectateMenu", 1), disabled: false },
        ...
        { id: 5, row: 1, text: "Вверх", action: () => window.sendClientEvent(0, "OnSelectSpectateMenu", 4), disabled: false },
        ...
        { id: 15, text: "Все", action: () => window.sendClientEvent(0, "OnSelectSpectateTab", 0), disabled: false },
        { id: 16, text: "Случ", action: () => window.sendClientEvent(0, "OnSelectSpectateTab", 1), disabled: false },
        { id: 17, text: "Рабоч", action: () => window.sendClientEvent(0, "OnSelectSpectateTab", 2), disabled: false },
        { id: 18, text: "Маф", action: () => window.sendClientEvent(0, "OnSelectSpectateTab", 3), disabled: false },
        { id: 19, text: "Капт", action: () => window.sendClientEvent(0, "OnSelectSpectateTab", 4), disabled: false },
        { id: 20, text: "Гос", action: () => window.sendClientEvent(0, "OnSelectSpectateTab", 5), disabled: false },
        { id: 21, text: "Нов", action: () => window.sendClientEvent(0, "OnSelectSpectateTab", 6), disabled: false },
        { id: 22, text: "Выход", action: () => window.sendClientEvent(0, "OnSelectSpectateMenu", 6), disabled: false },
    ],
    icons: [{
        title: "sp",
        id: undefined,
